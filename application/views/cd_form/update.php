...
<div>    
    <div class="col-md-6">
        ...
        <form id="form_1" method="post" action="/cd/update?id=<?= $product->getID(); ?>">
            ...
            <div class="form-group">
                <label for="playlenght">Playlenght:</label>

                <input required class="form-control" type="text" name="playlenght" value="<?= $product->getPlaylenght(); ?>">
            </div>
