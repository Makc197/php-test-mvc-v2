...
<div class="col-md-6">
    <!--<form id="form_id1" method="post" action="/pdfgenerator/createpdf/?formname=Click">-->
    <form id="form_id1" method="post" action="">
        ...
        <div>
            <input type="button" class="btn btn-primary btn-large" value="Сформировать заявление" onclick="AjaxFormRequest('result_div_id1', 'form_id1', '/pdfgenerator/createpdf/?formname=Click')" >
            <!--<input type="submit" class="btn btn-primary btn-large" value="Сформировать заявление">-->
...
<script src="/js/pdf_forms/click/click.js"></script>
